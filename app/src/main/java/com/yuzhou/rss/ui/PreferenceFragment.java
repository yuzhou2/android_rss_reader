...
//        args.putString(ARG_PARAM2, param2);
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view.findViewById(R.id.prefs__layout_title_only).setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        view.findViewById(R.id.prefs__layout_list).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        view.findViewById(R.id.prefs__layout_card).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
